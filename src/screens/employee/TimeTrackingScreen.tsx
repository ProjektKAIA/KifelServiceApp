// src/screens/employee/TimeTrackingScreen.tsx
...
import { useTimeStore, LocationData } from '../../store/timeStore';
...
export default function TimeTrackingScreen() {
  ...
  const handleClockOut = async () => {
    Alert.alert(
      'Arbeitsende',
      'Möchten Sie Ihre Arbeitszeit jetzt beenden?',
      [
      ...
      <View style={styles.content}>
        ...
        <View style={styles.gpsStatus}>
          <View style={[styles.gpsDot, { 
            backgroundColor: currentLocation && !locationError ? '#22c55e' : '#ef4444' 
          }]} />
          <Text style={[styles.gpsText, { 
            color: currentLocation && !locationError ? '#4ade80' : '#f87171' 
          }]}>
            {isLocationLoading 
        ...
        <View style={[styles.workCard, {
          ...
          <Text style={[styles.workLabel, { color: theme.textMuted }]}>
            Heutige Arbeitszeit
          </Text>
          <Text style={[styles.workTime, { color: theme.text }]}>
          ...
          {isTracking && (
            <View style={[styles.statusPill, { backgroundColor: theme.pillSuccess }]}>
              ...
              <Text style={[styles.statusText, { color: theme.pillSuccessText }]}>
                Aktiv seit {new Date().toLocaleTimeString('de-DE', { hour: '2-digit', minute: '2-digit' })}
              </Text>
            </View>
          )}
        </View>
        ...
        <View style={[styles.locationCard, {
          ...
          <Text style={[styles.locationAddress, { color: theme.textMuted }]}>
            {currentLocation?.address || 'Adresse wird ermittelt...'}
          </Text>
          {currentLocation && !locationError && (
