...
import { Briefcase, Users, Heart, Send, ChevronLeft } from 'lucide-react-native';
...
export default function CareerScreen() {
  ...
  const positions = ['Servicemitarbeiter/in', 'Teamleiter/in', 'Initiativbewerbung'];
      ...
      >
        <ScrollView contentContainerStyle={styles.content}>
          <View style={styles.header}>
            ...
            <Text style={[styles.headerLarge, { color: theme.text }]}>Karriere</Text>
          </View>
          ...
          <View style={[styles.benefitsCard, {
            ...
            <Text style={[styles.benefitsTitle, { color: theme.text }]}>Was wir bieten</Text>
            {benefits.map((benefit, index) => (
              <View key={index} style={styles.benefitRow}>
                ...
                <View style={styles.benefitContent}>
                  ...
                  <Text style={[styles.benefitDescription, { color: theme.textMuted }]}>{benefit.description}</Text>
                </View>
              </View>
            ))}
          </View>
          ...
          <Text style={[styles.inputLabel, { color: theme.textMuted }]}>Position *</Text>
...
const styles = StyleSheet.create({
  ...
  benefitsCard: { borderRadius: borderRadius.card, borderWidth: 1, padding: spacing.base, marginBottom: spacing.xl },
  benefitsTitle: { fontSize: 16, fontWeight: '600', marginBottom: spacing.md },
  benefitRow: { flexDirection: 'row', alignItems: 'center', marginBottom: spacing.md },
  benefitIcon: { width: 36, height: 36, borderRadius: borderRadius.sm, alignItems: 'center', justifyContent: 'center', marginRight: spacing.md },
  ...
  inputLabel: { fontSize: 12, fontWeight: '500', marginBottom: spacing.sm },
  input: { padding: 14, borderRadius: borderRadius.input, borderWidth: 1, fontSize: 14, marginBottom: spacing.md },
  textArea: { height: 100, paddingTop: 14 },
  positionContainer: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.sm, marginBottom: spacing.md },
  positionButton: { paddingVertical: 10, paddingHorizontal: 16, borderRadius: borderRadius.button, borderWidth: 1 },
  positionText: { fontSize: 13, fontWeight: '500' },
  submitButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: spacing.sm, padding: 14, borderRadius: borderRadius.button, backgroundColor: '#3b82f6', marginTop: spacing.sm },
